...
import { WeaponResponse, SkillResponse, BaseGearResponse, SaveGearRequest, RegisterRequest, ResetPasswordRequest, Gear, GearStatsResponse, Gearset } from '../types';
...
export class LaravelApiService {
  ...
  getRecentGearsetsUrl: string = 'api/get-recent-gearsets';
  ...
  getRecentGearsets(): Observable<Gearset[]> {
    return this.http.get<Gearset[]>(this.getRecentGearsetsUrl);
  }
